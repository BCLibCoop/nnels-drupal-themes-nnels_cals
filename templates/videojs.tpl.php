...
if (!empty($items)): ?>
<video id="<?php print $player_id; ?>-video" data-setup='{ "userActions": { "hotkeys": true },
"fluid": true }'
       class="<?php
print
  htmlspecialchars($class); ?>" width="<?php print $width; ?>" height="<?php print $height; ?>"<?php echo $attrs; ?>>
